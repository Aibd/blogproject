...
def handler400(request):
    response = render('error_page.html', {'title': '400 Bad Request', 'message': '400'},
...
def handler403(request):
    response = render('error_page.html', {'title': '403 Permission Denied', 'message': '403'},
                                  context=csrf(request))
...
def handler404(request):
    response = render('error_page.html', {'title': '404 Not Found', 'message': '404'},
                                  context=csrf(request))
...
def handler500(request):
    response = render('error_page.html', {'title': '500 Server Error', 'message': '500'},
                                  context=csrf(request))
