...
class Author(models.Model):
    user = models.ForeignKey(User, related_name='author',on_delete=False)
...
class Post(TimeStampedModel):
    author = models.ForeignKey(Author, related_name='author_post',on_delete=False)
    title = models.CharField(max_length=200)
    slug = models.SlugField(max_length=200, unique=True)
...
class Page(TimeStampedModel):
    author = models.ForeignKey(Author, related_name='author_page',on_delete=False)
    title = models.CharField(max_length=200)
    slug = models.SlugField(max_length=200, unique=True)
    description = RedactorField()
    publish = models.BooleanField(default=True)
...
class Visitor(TimeStampedModel):
    post = models.ForeignKey(Post, related_name='post_visitor',on_delete=False)
